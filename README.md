...
The dataset to be used is the [Kaggle Housing Prices Dataset](https://www.kaggle.com/c/house-prices-advanced-regression-techniques/data).
...
**Target (y):** House price in dollars (scaled from the dataset)
...
A trained model with a **low MAE, RMSE, and high R² score**.
A saved model that can make predictions on **new house data**.
Insights into **which factors influence house prices the most**.
