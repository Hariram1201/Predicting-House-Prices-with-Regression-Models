...
#Calls a function to use the gradient boosting model to determine the house prices
#gradBoostPredictions <- gradBoost(trainMatrix, trainLabel, testMatrix)
...
# Extract the MAE, RMSE, and R^2 values from the evaluation results
...
#Calls a function to use the XGBoost model to determine the house prices
#XGBoostPredictions <- xgboost(trainMatrix, trainLabel, testMatrix)
